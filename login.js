...
import { Container, Content, Footer,  H2, Item, Button, Left, Right, Body,  Text, Form, Label, Input } from 'native-base';
        ...
        <Body>
            ...
            <Label  >Mobile</Label>
              ...
              {/* </Item> */}
                ...
                <Body>
                    <Text >
                        Dont't have an account ? Swipe right to
                    </Text>
                    <TouchableOpacity>
                    <Text style={{color:"red"}}>Creat a new account.</Text>
                    </TouchableOpacity>
                </Body>
    </Content>
    </Container>
